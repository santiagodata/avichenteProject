"""
Django settings for avichenteProject project.
...
SECRET_KEY = 'django-insecure--e@tvg8^ru7mk6%20u&_@zk^m0a(t$e)*#f*g0(e)p*k-=48lm'
...
WSGI_APPLICATION = 'avichenteProject.wsgi.application'
